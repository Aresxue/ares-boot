 ...
 * @version: JDK 1.8
 */
public class RePutThreadPoolExecutor extends ThreadPoolExecutor {
  ...
  @NotNull
  private Set<Thread> initWorkerThreadSet(RejectedExecutionHandler handler) {
    Set<Thread> set = new ConcurrentHashSet<>();
    RePutRejectedExecutionHandler executionHandler = new RePutRejectedExecutionHandler(set, handler);
    super.setRejectedExecutionHandler(executionHandler);
    return set;
  }
